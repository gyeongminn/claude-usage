...
<p align="center">
  <img src="../assets/ja/dashboard.png" alt="Claude Usage — live dashboard" width="380">
</p>
...
<table>
  <tr>
    <td width="50%"><img src="../assets/ja/dashboard-dark.png" alt="Dark theme"></td>
    <td width="50%"><img src="../assets/ja/detail.png" alt="Details — model usage share and token composition"></td>
  </tr>
  <tr>
    <td width="50%"><img src="../assets/ja/detail-dark.png" alt="Details (dark theme)"></td>
    <td width="50%"><img src="../assets/ja/responsive.png" alt="Responsive layout at a narrow width"></td>
  </tr>
</table>
